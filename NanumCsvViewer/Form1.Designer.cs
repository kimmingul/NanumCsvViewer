namespace NanumCsvViewer
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // openFileDialog1
            // 
            openFileDialog1.Filter = "All Supported|*.csv;*.txt;*.xlsx;*.xlsm;*.xls;*.sas7bdat;*.sav|CSV / Text (*.csv;*.txt)|*.csv;*.txt|Excel (*.xlsx;*.xls)|*.xlsx;*.xlsm;*.xls|SAS (*.sas7bdat)|*.sas7bdat|SPSS (*.sav)|*.sav|All Files (*.*)|*.*";
